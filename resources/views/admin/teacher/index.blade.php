                            ...
                            <div class="modal-body p-4">
                                <form id="editForm" class="" action=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="edit_email" class="form-control" name="email" type="text"
                                            placeholder="Email">
                                            <span class="text-danger error email_error"></span>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="edit_password" class="form-control" name="password" type="text"
