                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form id="loginForm" class="form-horizontal m-t-30" action="{{ route('login') }}" method="POST">
                                  @csrf

                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Username</label>
                                        <input id="emailaddress" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 text-center">
                              @if (Route::has('password.request'))
                                ...
                                @endif
                              <p class="text-white-50">Support Helpline: <a href="#" class="text-white ml-1"><b>0000-062920</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
