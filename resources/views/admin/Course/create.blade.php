            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.course.store') }}" method="POST" id="createForm">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="course_pic">Course Picture <span class="text-danger">&#42;</span></label>
                                                <input id="course_pic" class="form-control" name="course_pic" type="file">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="selling_price" class="form-control" name="selling_price" type="text" placeholder="Enter Selling Price">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="duration">Durations <span class="text-danger">&#42;</span></label>
                                                <input id="duration" class="form-control" name="duration" type="text" placeholder="Enter Duration">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="long_description" class="form-control" id="long_description" rows="5" placeholder="Enter Long Description"></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="reg_end_date">Registraion End Date <span class="text-danger">&#42;</span></label>
                                                <input id="reg_end_date" class="form-control" name="reg_end_date" type="date">
                                                <span class="text-danger error reg_end_date_error"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="no_of_semester">Semester Number <span class="text-danger">&#42;</span></label>
                                                <input id="no_of_semester" class="form-control" name="no_of_semester" type="text" placeholder="Enter Semester Number">
