                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">Enter your Username and password to access teachers panel.
                                </p>
                            </div>

                            <form id="loginForm" class="form-horizontal m-t-30" action="{{ route('teacher.login') }}"
                                method="POST">
                                @csrf
